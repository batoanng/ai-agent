...
Apply this skill when the task matches the description above. Follow the workflow, decision tree, replacement rules, and expected output below. Use the reference file as the working replacement matrix when needed.
