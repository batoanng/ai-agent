...
Apply this skill when the task matches the description above. Follow the workflow, decision rules, API checklist, guardrails, and expected output below. Use the reference file when you need examples or anti-patterns.
