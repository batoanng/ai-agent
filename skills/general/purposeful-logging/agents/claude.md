...
Apply this skill when the task matches the description above. Follow the workflow, decision rules, and output expectations below. Use the reference file only when you need sharper signal-selection guidance or examples.
