...
Apply this skill when the task matches the description above. Follow the workflow, test-level selection rules, and expected output below. Use the reference file only when you need a refresher on the TDD cycle.
