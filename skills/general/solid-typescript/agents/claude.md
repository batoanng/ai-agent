...
Apply this skill when the task matches the description above. Follow the workflow, pressure checks, and expected output below. Use the reference files only when you need the extracted SOLID summaries or the React-specific translation.
