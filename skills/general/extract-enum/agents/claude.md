...
Apply this skill when the task matches the description above. Follow the workflow, decision rules, and output expectations below. Use the reference file only when it helps resolve an enum-vs-union decision or migration detail.
